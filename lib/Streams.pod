...
There are also L<Streams::IOError> and L<Streams::Devel>.
...
specified by WHATWG Streams Standard.

=head1 DEPENDENCY

Perl 5.8 or later is required.  The L<Scalar::Util> module, which is a
